...
# td;lr
Instructions in the `README` for repo are also in included in the header of `0_HW3.Rmd`. Answer the questions listed in `0_HW3.Rmd`. Use the basic autograding system implemented in the same rmarkdown file ONLY as a reference. Do **NOT** include additional files to your repo (e.g. datasets; **penalty -2 points**). 
